...
#Read user input
	#$RemoteAddress = $InputBox.text;	
#Test connection
	#$CommandResults = ping $RemoteAddress -n 1 | fl | Out-String;	
#Output actions
	#$OutputBox.text = $CommandResults
...
function NewFirewallRule{
	...
	$OutputBox.text = "The following new inbound/outbound rules added:`n"
}
...
$Form.Size = New-Object System.Drawing.Size(555,350)
$Form.Icon = [System.Drawing.Icon]::ExtractAssociatedIcon('C:\Users\markus.pyharanta\Desktop\kuvat\fw_icon.ico')
...
$OutputBox.Size = New-Object System.Drawing.Size(525,120)
...
$File = (Get-Item 'C:\Users\markus.pyharanta\Desktop\kuvat\caged3.png')
